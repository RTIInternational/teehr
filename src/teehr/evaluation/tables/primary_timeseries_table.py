...
class PrimaryTimeseriesTable(TimeseriesTable):
    ...
    def __init__(self, ev):
        """Initialize class."""
        super().__init__(ev)
        table_props = TBLPROPERTIES["primary_timeseries"]
        self.format = table_props["file_format"]
        self.filter_model = table_props["filter_model"]
        self.uniqueness_fields = table_props["uniqueness_fields"]
        self.table_name = "primary_timeseries"
