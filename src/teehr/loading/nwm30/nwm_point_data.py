...
from teehr.loading.nwm30.utils_nwm import (
    build_remote_nwm_filelist,
    build_zarr_references,
    get_dataset,
)

from teehr.loading.nwm30.point_config_models import PointConfigurationModel

from teehr.loading.nwm30.const_nwm import NWM30_UNIT_LOOKUP
...
def file_chunk_loop(
    ...
    teehr_units = NWM30_UNIT_LOOKUP.get(nwm22_units, nwm22_units)
    ...
    teehr_location_ids = [f"nwm30-{feat_id}" for feat_id in feature_ids]
    num_vals = vals.size
