...
from teehr.loading.nwm30.const_nwm import (
...
def build_remote_nwm_filelist(
    ...
    if "assim" in configuration:
        cycle_z_hours = NWM30_ANALYSIS_CONFIG[configuration]["cycle_z_hours"]
        domain = NWM30_ANALYSIS_CONFIG[configuration]["domain"]
        configuration_name_in_filepath = NWM30_ANALYSIS_CONFIG[configuration][
            "configuration_name_in_filepath"
        ]
        max_lookback = NWM30_ANALYSIS_CONFIG[configuration]["num_lookback_hrs"]
