...
def join_and_insert_timeseries(
    primary_filepath: str,
    secondary_filepath: str,
    crosswalk_filepath: str,
    order_by: List[str],
    ...
    * lead_time
    ...
    # TODO: No need for filters here? That would be in the query

    # Join primary and secondary and insert into table 'timeseries'
    con.sql(query)

    # Merge .wal into db file
    # - .wal contains list of changes made to database
    # - checkpoint basically merges these changes into the main .db file
    # - after checkpoint and closing the connection the .wal file goes away
    # - reference: https://github.com/duckdb/duckdb/issues/301#issuecomment-1011335087
    # - sqlite runs checkpoint automatically when it reaches 1000 pages in size
    # TODO: How ofen to run?
    # con.sql("CHECKPOINT;")
