...
# PRIMARY_TIMESERIES_FILEPATH = Path(TEST_DATA_DIR, "timeseries", "test_short_obs.parquet")
# CROSSWALK_FILEPATH = Path(TEST_DATA_DIR, "geo", "crosswalk.csv")
# SECONDARY_TIMESERIES_FILEPATH = Path(TEST_DATA_DIR, "timeseries", "test_short_fcast.parquet")
