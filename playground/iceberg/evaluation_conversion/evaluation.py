...
class Evaluation:
    ...
    def check_evaluation_version(self):
        ...
        # TODO: Automatically upgrade here?
        # if version < "0.6.0":
        #     err_msg = (
