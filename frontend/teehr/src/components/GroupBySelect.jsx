...
export default function GroupBySelect(props) {
   ...
   const { groupByFields, setGroupByFields, selectedGroupByFields, setSelectedGroupByFields, selectedDataset } = props;
         ...
         {!loading ? (
            !errors ? (
               <FormControl sx={{ m: 1, display: 'flex' }}>
                  <InputLabel id="demo-multiple-chip-label">Group By Fields</InputLabel>
                  <Select
