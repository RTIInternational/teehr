...
$ python -m build
$ python -m pip install dist/teehr-0.2.4.tar.gz
```
...
Use Docker
```bash
$ docker build -t teehr:v0.2.4 .
$ docker run -it --rm --volume $HOME:$HOME -p 8888:8888 teehr:v0.2.4 jupyter lab --ip 0.0.0.0 $HOME
```
